...
const TweakToggleItem = ({ tweak, isChecked, onToggle }) => {
  return (
...
export const Tweaks = () => {
  ...
  const handleToggleTweak = (id, isChecked) => {
  ...
  const categories = ['Performance', 'Network', 'Privacy', 'UI', 'System Repair', 'Advanced'];
